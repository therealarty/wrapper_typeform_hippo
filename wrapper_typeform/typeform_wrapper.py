    ...
    def typeform_raws (self,typeform_id):
        ...
        if form.status_code!=200:
            ...
            while len(responses_temp['items'])!=0:
                ...
                responses_temp=requests.get('https://api.typeform.com/forms/'+typeform_id+'/responses'+'?page_size=500&completed=1&before='+last_token, headers={'authorization': 'bearer '+self.auth()})
                responses_temp=responses_temp.json()
    ...
    def typeform_to_DF (self,typeform_id,uuid_hidden_fieldname='',email_hidden_fieldname='',custom_hidden_fieldname_list=[]):
        ...
        if form.status_code!=200:
            ...
            for i in range(len(reponses)):
                ...
                elif 'uuid' in reponses[i].get('hidden',{}).keys() :
                ...
                if email_hidden_fieldname in reponses[i].get('hidden',{}).keys():
